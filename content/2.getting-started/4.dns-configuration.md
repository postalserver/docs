...
The domain name of the email server requires an MX record pointing to `postal.axample.com`. Of course, as an alternative, you can also specify some dedicated subdomains:
